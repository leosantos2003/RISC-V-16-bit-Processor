...
* **Version 3:** `risc_v_pc_po`. Version with Datapath/Controller division. This version focuses on structural organization and good RTL design practices, explicitly separating the hardware into two large blocks.
